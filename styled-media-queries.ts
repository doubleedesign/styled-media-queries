...
type ThemeObject = Interpolation<{ theme: DefaultTheme }>;
 ...
 */
export function viewportWidthUp(breakpoint: number, styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function breakpointUp(breakpoint: number, styles: ThemeObject) {
 ...
 * @param {ThemeObject} styles
 */
export function viewportWidthDown(breakpoint: number, styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function breakpointDown(breakpoint: number, styles: ThemeObject) {
 ...
 * @param {ThemeObject} styles
 */
export function viewportWidthBetween(startBreakpoint: number, endBreakpoint: number, styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function breakpointBetween(startBreakpoint: number, endBreakpoint: number, styles: ThemeObject) {
 ...
 * @param {ThemeObject} styles
 */
export function viewportHeightUp(height: number, styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function viewportHeightDown(height: number, styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function viewportMinAspectRatio(width: number, height: number, styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function viewportMaxAspectRatio(width: number, height: number, styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function userPrefersLessContrast(styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function userPrefersMoreContrast(styles: ThemeObject) {
    return css`
 ...
 * @param {ThemeObject} styles
 */
export function userPrefersReducedMotion(styles: ThemeObject) {
    return css`
